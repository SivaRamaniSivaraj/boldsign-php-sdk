...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.boldsign.com';
     ...
     * @var string
     */
    protected $userAgent = 'boldsign-php-sdk/3.2.0-beta.4';
    ...
    {
        $report  = 'PHP SDK (BoldSign) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1' . PHP_EOL;
        $report .= '    SDK Package Version: 3.2.0-beta.4' . PHP_EOL;
