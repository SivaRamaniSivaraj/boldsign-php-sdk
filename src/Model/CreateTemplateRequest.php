    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 256)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CreateTemplateRequest., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($title) < 0)) {
            throw new \InvalidArgumentException('invalid length for $title when calling CreateTemplateRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateTemplateRequest., must be smaller than or equal to 5000.');
        }
        if (!is_null($description) && (mb_strlen($description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateTemplateRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDocumentTitle($document_title)
    {
        ...
        if (!is_null($document_title) && (mb_strlen($document_title) > 256)) {
            throw new \InvalidArgumentException('invalid length for $document_title when calling CreateTemplateRequest., must be smaller than or equal to 256.');
        }
        if (!is_null($document_title) && (mb_strlen($document_title) < 0)) {
            throw new \InvalidArgumentException('invalid length for $document_title when calling CreateTemplateRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDocumentMessage($document_message)
    {
        ...
        if (!is_null($document_message) && (mb_strlen($document_message) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $document_message when calling CreateTemplateRequest., must be smaller than or equal to 5000.');
        }
        if (!is_null($document_message) && (mb_strlen($document_message) < 0)) {
            throw new \InvalidArgumentException('invalid length for $document_message when calling CreateTemplateRequest., must be bigger than or equal to 0.');
        }
