...
/**
 * EditDocumentRequest Class Doc Comment
 *
 * @category Class
 * @package  BoldSign
 * @author   OpenAPI Generator team
 ...
 */
class EditDocumentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EditDocumentRequest';
    ...
    protected static $openAPITypes = [
        'files' => '\BoldSign\Model\EditDocumentFile[]',
        'title' => 'string',
        'message' => 'string',
        'signers' => '\BoldSign\Model\EditDocumentSigner[]',
    ...
    */
     ...
     * Gets files
     *
     * @return \BoldSign\Model\EditDocumentFile[]|null
     */
     ...
     * Sets files
     *
     * @param \BoldSign\Model\EditDocumentFile[]|null $files files
     *
     * @return self
     */
    ...
    public function setTitle($title)
    {
        ...
        if (!is_null($title) && (mb_strlen($title) > 256)) {
            throw new \InvalidArgumentException('invalid length for $title when calling EditDocumentRequest., must be smaller than or equal to 256.');
        }
        if (!is_null($title) && (mb_strlen($title) < 0)) {
            throw new \InvalidArgumentException('invalid length for $title when calling EditDocumentRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setMessage($message)
    {
        ...
        if (!is_null($message) && (mb_strlen($message) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $message when calling EditDocumentRequest., must be smaller than or equal to 5000.');
        }
        if (!is_null($message) && (mb_strlen($message) < 0)) {
            throw new \InvalidArgumentException('invalid length for $message when calling EditDocumentRequest., must be bigger than or equal to 0.');
        }
     ...
     * Gets signers
     *
     * @return \BoldSign\Model\EditDocumentSigner[]|null
     */
     ...
     * Sets signers
     *
     * @param \BoldSign\Model\EditDocumentSigner[]|null $signers signers
     *
     * @return self
     */
    ...
    public function setDisableEmails($disable_emails)
    {
        if (is_null($disable_emails)) {
            array_push($this->openAPINullablesSetToNull, 'disable_emails');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('disable_emails', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setDisableSms($disable_sms)
    {
        if (is_null($disable_sms)) {
            array_push($this->openAPINullablesSetToNull, 'disable_sms');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('disable_sms', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setDownloadFileName($download_file_name)
    {
        ...
        if (!is_null($download_file_name) && (mb_strlen($download_file_name) > 250)) {
            throw new \InvalidArgumentException('invalid length for $download_file_name when calling EditDocumentRequest., must be smaller than or equal to 250.');
        }
        if (!is_null($download_file_name) && (mb_strlen($download_file_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $download_file_name when calling EditDocumentRequest., must be bigger than or equal to 0.');
        }
