...
/**
 * EditFormField Class Doc Comment
 *
 * @category Class
 * @package  BoldSign
 * @author   OpenAPI Generator team
 ...
 */
class EditFormField implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EditFormField';
    ...
    public const EDIT_ACTION_ADD = 'Add';
    public const EDIT_ACTION_UPDATE = 'Update';
    public const EDIT_ACTION_REMOVE = 'Remove';
     ...
     * @return string[]
     */
    public function getEditActionAllowableValues()
    {
        return [
            self::EDIT_ACTION_ADD,
            self::EDIT_ACTION_UPDATE,
            self::EDIT_ACTION_REMOVE,
        ];
    }
    ...
    {
        $this->setIfExists('edit_action', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['edit_action'] === null) {
            $invalidProperties[] = "'edit_action' can't be null";
        }
        $allowedValues = $this->getEditActionAllowableValues();
        if (!is_null($this->container['edit_action']) && !in_array($this->container['edit_action'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'edit_action', must be one of '%s'",
                $this->container['edit_action'],
    ...
    {
        return $this->container['edit_action'];
    }

    /**
     * Sets edit_action
     *
     * @param string $edit_action edit_action
     *
     * @return self
     */
    public function setEditAction($edit_action)
    {
        if (is_null($edit_action)) {
            throw new \InvalidArgumentException('non-nullable edit_action cannot be null');
        }
        $allowedValues = $this->getEditActionAllowableValues();
        if (!in_array($edit_action, $allowedValues, true)) {
        ...
        $this->container['edit_action'] = $edit_action;
    ...
    public function setFontSize($font_size)
    {
        ...
        if (!is_null($font_size) && ($font_size < 0)) {
            throw new \InvalidArgumentException('invalid value for $font_size when calling EditFormField., must be bigger than or equal to 0.');
        }
    ...
    public function setFont($font)
    {
        ...
        $allowedValues = $this->getFontAllowableValues();
        if (!is_null($font) && !in_array($font, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'font', must be one of '%s'",
                    $font,
    ...
    public function setIsBoldFont($is_bold_font)
    {
        if (is_null($is_bold_font)) {
            array_push($this->openAPINullablesSetToNull, 'is_bold_font');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_bold_font', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setIsItalicFont($is_italic_font)
    {
        if (is_null($is_italic_font)) {
            array_push($this->openAPINullablesSetToNull, 'is_italic_font');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_italic_font', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setIsUnderLineFont($is_under_line_font)
    {
        if (is_null($is_under_line_font)) {
            array_push($this->openAPINullablesSetToNull, 'is_under_line_font');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_under_line_font', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setLineHeight($line_height)
    {
        ...
        if (!is_null($line_height) && ($line_height > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $line_height when calling EditFormField., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($line_height) && ($line_height < 0)) {
            throw new \InvalidArgumentException('invalid value for $line_height when calling EditFormField., must be bigger than or equal to 0.');
        }
    ...
    public function setCharacterLimit($character_limit)
    {
        if (is_null($character_limit)) {
            array_push($this->openAPINullablesSetToNull, 'character_limit');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('character_limit', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($character_limit) && ($character_limit > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $character_limit when calling EditFormField., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($character_limit) && ($character_limit < 0)) {
            throw new \InvalidArgumentException('invalid value for $character_limit when calling EditFormField., must be bigger than or equal to 0.');
        }
    ...
    public function setTextDirection($text_direction)
    {
        ...
        $allowedValues = $this->getTextDirectionAllowableValues();
        if (!is_null($text_direction) && !in_array($text_direction, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'text_direction', must be one of '%s'",
                    $text_direction,
    ...
    public function setTabIndex($tab_index)
    {
        ...
        if (!is_null($tab_index) && ($tab_index > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $tab_index when calling EditFormField., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($tab_index) && ($tab_index < -1)) {
            throw new \InvalidArgumentException('invalid value for $tab_index when calling EditFormField., must be bigger than or equal to -1.');
        }
    ...
    public function setAllowEditFormField($allow_edit_form_field)
    {
        if (is_null($allow_edit_form_field)) {
            array_push($this->openAPINullablesSetToNull, 'allow_edit_form_field');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('allow_edit_form_field', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setAllowDeleteFormField($allow_delete_form_field)
    {
        if (is_null($allow_delete_form_field)) {
            array_push($this->openAPINullablesSetToNull, 'allow_delete_form_field');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('allow_delete_form_field', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
