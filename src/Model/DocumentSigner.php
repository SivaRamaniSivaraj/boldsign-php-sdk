...
/**
 * DocumentSigner Class Doc Comment
 *
 * @category Class
 * @package  BoldSign
 * @author   OpenAPI Generator team
 ...
 */
class DocumentSigner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentSigner';
    ...
    */
    ...
    public function setPrivateMessage($private_message)
    {
        ...
        if (!is_null($private_message) && (mb_strlen($private_message) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $private_message when calling DocumentSigner., must be smaller than or equal to 5000.');
        }
    ...
    public function setAuthenticationCode($authentication_code)
    {
        ...
        if (!is_null($authentication_code) && (mb_strlen($authentication_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $authentication_code when calling DocumentSigner., must be smaller than or equal to 50.');
        }
    ...
    public function setAuthenticationRetryCount($authentication_retry_count)
    {
        ...
        if (!is_null($authentication_retry_count) && ($authentication_retry_count > 10)) {
            throw new \InvalidArgumentException('invalid value for $authentication_retry_count when calling DocumentSigner., must be smaller than or equal to 10.');
        }
        if (!is_null($authentication_retry_count) && ($authentication_retry_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $authentication_retry_count when calling DocumentSigner., must be bigger than or equal to 1.');
        }
